...
public class ManageReservationsForm extends javax.swing.JFrame {
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addComponent(jButtonAddReservation, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(35, 35, 35)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jButtonRemoveReservation, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(49, 49, 49)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jDateChooserDateIN, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
    ...
    private void jButtonAddReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddReservationActionPerformed
         try{
            ...
            {
                JOptionPane.showMessageDialog(rootPane, "The Date In Must Be After Or Equal Today Date", "Date IN Error", JOptionPane.ERROR_MESSAGE);
            }
            else if(!(dout.after(din) || dout.equals(din)))
            {
                JOptionPane.showMessageDialog(rootPane, "The Date Out Must Be After Or Equal Date IN", "Date OUT Error", JOptionPane.ERROR_MESSAGE);
            }else{
            ...
            {
                JOptionPane.showMessageDialog(rootPane, ex.getMessage() + "Enter The Room Number + Client ID","Input Fields Error" , JOptionPane.WARNING_MESSAGE);
            } 
            catch (ParseException ex) {
               Logger.getLogger(ManageReservationsForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonEditReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditReservationActionPerformed
            ...
            {
                JOptionPane.showMessageDialog(rootPane, ex.getMessage() + "Enter Room Number + Client ID + Reservation ID","Data Error" , JOptionPane.WARNING_MESSAGE);
            }
            catch(NullPointerException ex)
            {
                JOptionPane.showMessageDialog(rootPane, ex.getMessage() + "Select Date IN + OUT","Date Error" , JOptionPane.WARNING_MESSAGE);
            }
            catch (ParseException ex) {
               Logger.getLogger(ManageReservationsForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButtonRemoveReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveReservationActionPerformed
       try{
            ...
            {
                JOptionPane.showMessageDialog(rootPane, ex.getMessage() + "Enter Reservation ID","Reservation ID Error" , JOptionPane.WARNING_MESSAGE);
            }
